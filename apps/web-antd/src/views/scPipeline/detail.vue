...
import { getPipeline, getStepHistory, runStep, updateStepParams } from './mock/mockApi';
...
const showHistory = async () => {
  ...
  try {
    historyList.value = await getStepHistory(pipelineId.value, selectedStepType.value);
  } catch (error) {
      ...
      <template v-if="pipeline">
        ...
        <div class="main-content">
          ...
          <div class="center-panel">
            <Tabs v-model:activeKey="activeTab" class="center-tabs">
              <Tabs.TabPane key="config">
                ...
                <div class="tab-content">
                  <StepConfigPanel
                    ...
                    :disabled="selectedStepIndex > 0 && pipeline.steps[selectedStepIndex - 1]?.status !== 'completed'"
              ...
              <Tabs.TabPane key="result">
                <template #tab>
                  <span class="tab-label">
                    ...
                    分析结果
                    <span v-if="selectedStep?.status === 'completed'" class="result-badge">✓</span>
                  </span>
                </template>
                <div class="tab-content">
                  <StepResultPanel
