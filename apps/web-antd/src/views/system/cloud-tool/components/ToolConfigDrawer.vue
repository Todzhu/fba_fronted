            ...
            <template v-else-if="column.dataIndex === 'action'">
              <Space :size="4">
                <Button
                  type="link"
                  size="small"
                  @click="openParamEditModal(index)"
                >
                  编辑
                </Button>
          ...
          <Form layout="vertical" class="param-edit-form">
            <Row :gutter="16">
              <Col :span="12">
                <Form.Item label="参数 Key" required>
                  <Input
                    v-model:value="editingParam.key"
                    placeholder="参数唯一标识"
                  />
                </Form.Item>
              </Col>
              <Col :span="12">
                <Form.Item label="参数标题">
                  <Input
                    v-model:value="editingParam.title"
                    placeholder="显示名称"
                  />
                </Form.Item>
              </Col>
            ...
            <Row :gutter="16">
              ...
              <Col :span="12">
                <Form.Item label="默认值">
                  <Input
                    v-model:value="editingParam.default"
                    placeholder="默认值"
                  />
                </Form.Item>
              </Col>
            ...
            <Row :gutter="16">
              <Col :span="12">
                <Form.Item label="分组">
                  <Input
                    v-model:value="editingParam.group"
                    placeholder="通用参数"
                  />
                </Form.Item>
              </Col>
