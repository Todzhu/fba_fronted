    ...
    <template v-else-if="task">
      ...
      <div class="info-card">
        ...
        <div class="info-meta">
          ...
          <div class="meta-item"><span class="meta-label">文件数量</span><span class="meta-value">{{ allFiles.length }} 个 <span v-if="totalImages" class="text-green-600">({{ totalImages }} 图片)</span><span v-if="totalTables" class="text-blue-600">({{ totalTables }} 表格)</span></span></div>
        </div>
      </div>
